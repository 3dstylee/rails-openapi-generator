...
RSpec.describe "Generate an OpenAPI document for all endpoints", :rails_app do
  ...
  it "produces an operation for every resolvable route" do
    ...
    expect(document["paths"].keys).to contain_exactly(
      "/api/activity_logs",
      "/api/binding_helpers/chain", "/api/binding_helpers/create",
      "/api/binding_helpers/kwargs",
      ...
      "/api/nested_params/empty_block", "/api/nested_params/moods",
      "/api/nested_params/nested", "/api/nested_params/non_hash_block",
      "/api/nested_params/search", "/api/nested_params/tags",
      ...
      "/api/respond_to/index", "/api/respond_to/json_only", "/api/respond_to/unmapped",
